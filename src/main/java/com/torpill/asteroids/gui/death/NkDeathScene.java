package com.torpill.asteroids.gui.death;
...
public class NkDeathScene implements NuklearScene {
    ...
    private final DeathGui pause = new DeathGui();
    ...
    public void update(@NotNull Window window, @NotNull Nuklear nk) {
        ...
        NkColor red = NkColor.create().set(
                (byte) 0xA5,
                (byte) 0x00,
                (byte) 0x00,
                (byte) (0xFF * opacity)
        ...
        ctx.style().window().header().active().data().color().set(red);
